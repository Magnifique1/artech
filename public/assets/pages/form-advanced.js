!function (t) {
    ...
    e.prototype.init = function () {
        t(".colorpicker-default").colorpicker({format: "hex"}), t(".colorpicker-rgba").colorpicker(), jQuery("#datepicker").datepicker(), jQuery("#datepicker-autoclose").datepicker({
            autoclose: !0,
            todayHighlight: !0
            ...
            multidate: !0,
            multidateSeparator: ","
        }), jQuery("#date-range").datepicker({toggleActive: !0}), t("input#defaultconfig").maxlength({
            ...
            time: !0,
            date: !1
        }), t("#date-format").bootstrapMaterialDatePicker({format: "dddd DD MMMM YYYY - HH:mm"}), t("#min-date").bootstrapMaterialDatePicker({
            format: "DD/MM/YYYY HH:mm",
            minDate: new Date
        }), t("#single-input").clockpicker({
            placement: "bottom",
            align: "left",
            autoclose: !0,
            default: "now"
        }), t(".clockpicker").clockpicker({donetext: "Done"}).find("input").change(function () {
            console.log(this.value)
        }), t("#check-minutes").click(function (t) {
            t.stopPropagation(), input.clockpicker("show").clockpicker("toggleView", "minutes")
        }), t(".colorpicker").asColorPicker(), t(".gradient-colorpicker").asColorPicker({mode: "gradient"}), t(".complex-colorpicker").asColorPicker({mode: "complex"}), t(".select2").select2({width: "100%"})
